...
# This was implemented using a naive sorting approach and calculating the full distances matrix
# Other strategies can be more efficient depending on the population size and number of objectives
# This approach was the most promising for N = 3 and a population size < 30
# For population sizes > 30 using numpy quicksort implementation would make the algorithm faster
