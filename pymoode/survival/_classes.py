...
class RankAndCrowding(Survival):
    ...
    def __init__(
        ...
        if rule is not None:
            warnings.warn(
                "rule is deprecated; elimination methods are now included in crowding_func",
...
class ConstrRankAndCrowding(Survival):
    ...
    def __init__(self, nds=None, crowding_func="cd", ranking=None):
        """
        ...
        if ranking is not None:
            warnings.warn(
                "'ranking' is deprecated; internal survival operators are now constructed from nds and crowding_func",
                DeprecationWarning, 2
            )
